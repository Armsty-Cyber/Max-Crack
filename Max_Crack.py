		...
		for pw in _sempak_:
			...
			if 'c_user' in ses.cookies.get_dict():
				...
				try:
					...
					pass
				print('\r\033[1;91m[Armsty-CP] %s | %s%s      ' % (user,pw,tahun(user)))
...
\033[1;32m [+] Author  : Armsty
\033[1;32m [+] Fb ID   : Armstrong Ogbuagu
\033[1;32m [+] Version : 3.0
\033[1;32m [+] Github  : https://github.com/Armsty-Cyber
\033[1;32m==============================================
"""
ct = datetime.now()
n = ct.month
